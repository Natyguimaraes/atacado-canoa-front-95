    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Preencha as informações abaixo para adicionar um novo item ao catálogo.</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="stock" type="number" value={formData.stock} onChange={(e) => handleInputChange('stock', e.target.value)} placeholder="0" required />
              </div>
            </div>
            ...
            <div className="flex gap-4 justify-end pt-6">
              ...
              <Button type="submit" disabled={isLoading || !formData.name || !formData.category || !formData.price || formData.sizes.length === 0 || formData.images.length === 0 || !formData.stock}>
