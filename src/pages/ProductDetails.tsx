    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <div className="container mx-auto px-4 py-8">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {product.colors.map((color) => (
                      <Button key={color} variant={selectedColor === color ? 'default' : 'outline'} className="h-8 w-8 rounded-full p-0 border-2" style={{ backgroundColor: color.toLowerCase() }} aria-label={color}/>
                    ))}
                  </div>
                </div>
              )}
          ...
          <section>
            <h2 className="text-2xl font-bold font-display mb-6">Você também pode gostar</h2>
