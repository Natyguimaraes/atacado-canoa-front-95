...
('Calça Jeans Skinny Feminina', 'Calça jeans com elastano, modelagem skinny, cintura alta', 79.90, null, 'adulto', ARRAY['36', '38', '40', '42', '44'], ARRAY['Azul Escuro', 'Azul Claro'], ARRAY[]::text[], false, false, true),
...
('Camisa Social Masculina', 'Camisa social algodão premium, corte slim, colarinho italiano', 49.90, 69.90, 'adulto', ARRAY['P', 'M', 'G', 'GG'], ARRAY['Branco', 'Azul Claro', 'Preto'], ARRAY[]::text[], false, false, true),
...
('Bermuda Jeans Infantil', 'Bermuda jeans com elastano, bolsos funcionais, barra desfiada', 29.90, null, 'infantil', ARRAY['2', '4', '6', '8', '10'], ARRAY['Azul Claro', 'Azul Escuro'], ARRAY[]::text[], false, false, true),
...
('Body Bebê Manga Longa', 'Body em algodão premium, manga longa, abertura em botões', 19.90, 24.90, 'bebe', ARRAY['RN', 'P', 'M', 'G'], ARRAY['Branco', 'Rosa', 'Azul', 'Amarelo'], ARRAY[]::text[], true, false, true),

('Conjunto Bebê 3 Peças', 'Conjunto completo: body, calça e casaquinho, algodão orgânico', 59.90, 79.90, 'bebe', ARRAY['RN', 'P', 'M'], ARRAY['Rosa/Branco', 'Azul/Branco'], ARRAY[]::text[], false, true, true),

('Sapatinho Bebê Tricot', 'Sapatinho em tricot macio, solado antiderrapante, muito confortável', 15.90, null, 'bebe', ARRAY['14', '15', '16', '17'], ARRAY['Rosa', 'Azul', 'Branco', 'Amarelo'], ARRAY[]::text[], true, false, true);